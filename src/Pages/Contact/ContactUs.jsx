...
<>
     ...
     <Row>
     <Col md={12} lg={7}><DemoForm headText="Reach out to us anytime - we're here to assist you."/></Col>
     <Col md={12} lg={5} className='flex items-center w-full'>
     <ul class="w-full flex flex-col  divide-y divide-gray-200">
      ...
      <div className={Styles.ContactContainer} >
             ...
             <div className={`flex justify-around ${Styles.contactContent}`}>
                ...
                <div className={`w-[1px] bg-slate-200 h-[230px]${Styles.dividerBar}`}></div>
                <div className='flex-1 lg:pl-4 pl-12'>
                <div className='flex items-center'>
                ...
                <p className='text-white fw-bold'>Elnet Software City, TS 140, blocks 2 & 9, G4 A, Rajiv Gandi Salai, 
                Taramani, Chennai, Tamil Nadu, India - 600 113</p>
                </div>
                </div>
             </div>
      </div>
